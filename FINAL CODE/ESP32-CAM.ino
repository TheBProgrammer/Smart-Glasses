...
void setup() {
  ...
  Mclient.setCallback(callback); //Initialize the callback routine
...
void loop() { 
  ...
  if (!Mclient.connected()) { //Reconnect if connection is lost
    reconnect();
  }
  Mclient.loop();
}
